-- Database Schema for Adaptive AI-Based Personalized Learning Path System with Gamification
...
CREATE TABLE IF NOT EXISTS xp_transactions (
    ...
    source_type TEXT NOT NULL, -- 'lesson', 'quiz', 'streak', 'challenge', 'badge', 'milestone'
    source_id TEXT,
    description TEXT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS daily_challenges (
    ...
    title TEXT NOT NULL,
    description TEXT NOT NULL,
    target_type TEXT NOT NULL, -- 'lesson', 'quiz', 'coding', 'weak_topic', 'study_time'
    target_value INTEGER DEFAULT 1,
    reward_xp INTEGER DEFAULT 30,
    reward_coins INTEGER DEFAULT 15,
    is_personalized INTEGER DEFAULT 0,
    user_id INTEGER, -- NULL for global daily challenges, specific user_id for AI personalized
...
CREATE TABLE IF NOT EXISTS rewards (
    ...
    title TEXT NOT NULL,
    description TEXT NOT NULL,
    type TEXT NOT NULL, -- 'theme', 'badge', 'shield', 'xp_booster', 'challenge'
...
CREATE TABLE IF NOT EXISTS notifications (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
    type TEXT NOT NULL, -- 'level_up', 'badge', 'streak', 'challenge', 'system'
    title TEXT NOT NULL,
    message TEXT NOT NULL,
    is_read INTEGER DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
