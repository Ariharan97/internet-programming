...
def get_current_user_id():
    return session.get('user_id', 2) # Default fallback to sample student (id=2)
...
def submit_assessment():
    ...
    # Check previous score for score improvement bonus
    ...
    # 3. Score improvement bonus (+30 XP)
...
def complete_activity():
    ...
    # Award Gamification XP (+20 XP) & Coins (+5 Coins)
...
if __name__ == '__main__':
    print("Starting Adaptive AI Personalized Learning & Gamification Server on http://127.0.0.1:5000...")
